...
export class NewsItem extends Component {
  ...
  render() {
    ...
    return (
      <div className=''>
        <div className="card shadow-lg p-3 bg-body rounded" style={{ width: "100%",height: "30rem",}}>
        <span className="text-center position-absolute top-0 start-50 translate-middle badge rounded-pill bg-danger">{source}</span>
